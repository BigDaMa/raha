 ...
 * @param <E>
 */
public class RandomAccessEnabledHashSet<E> extends AbstractSet<E> implements Set<E>,
		Cloneable, java.io.Serializable {

	private static final long serialVersionUID = -785853115477886407L;
	 ...
	 */
	public RandomAccessEnabledHashSet() {
		map = new HashMap<>();
	}
	 ...
	 */
	public RandomAccessEnabledHashSet(Collection<? extends E> c) {
	 ...
	 */
	public RandomAccessEnabledHashSet(int initialCapacity, float loadFactor) {
	 ...
	 */
	public RandomAccessEnabledHashSet(int initialCapacity) {
	 ...
	 *             factor is nonpositive
	 */
	RandomAccessEnabledHashSet(int initialCapacity, float loadFactor, boolean dummy) {
	...
	/**
	 * Give a key, return the object stored in the set
	 * @param e key
	 * @return the object which equals to e but stored in set
	 */
	public E get(E e){
		return map.get(e);
	}
	...
	public Object clone() {
		try {
			RandomAccessEnabledHashSet<E> newSet = (RandomAccessEnabledHashSet<E>) super.clone();
