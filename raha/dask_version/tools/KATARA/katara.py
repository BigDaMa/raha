...
def run(data, domin_specific_file_path, type_coverage=0.2, pair_coverage=0.15, ignore_null=True, run_single=False):
    data = container.shared_dataframe.read().to_numpy().tolist() if run_single == False else data.dataframe.to_numpy().tolist()
